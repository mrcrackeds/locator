#!/bin/bash
# Locator v1.0
# Coded by: icammaci (You dont become a coder by just changing the credits)
# Github: https://github.com/icammaci/locator
...
printf "\n"
printf "\e[1;93m :::\e[0m\e[1;77m Coded by: icammaci\e[0m\n"
